...
export class SchoolsController {
  ...
  @Roles('DIRECTOR')
  async updateLevels(@Req() req: any, @Body() body: { levels: string[] }) {
  ...
  @Get('level-tuitions')
  async getLevelTuitions(@Req() req: any) {
    const schoolId = getCurrentSchoolId(req);
  ...
  @Post('complete-setup')
  async completeSetup(@Req() req: any) {
    const schoolId = getCurrentSchoolId(req);
  ...
  @Get('stats')
  async getStats(@Req() req: any, @Query('school_id') school_id?: string) {
  ...
  @Patch('me')
  async updateMySchool(@Req() req: any, @Body() body: UpdateSchoolDto) {
    const schoolId = getCurrentSchoolId(req);
  ...
  @UseGuards(SchoolContextGuard, PermissionGuard)
  @Roles('DIRECTOR')
  async updateFilieres(@Req() req: any, @Body() body: { filieres: string[] }) {
